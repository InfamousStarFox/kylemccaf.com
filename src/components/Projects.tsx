    ...
    return (
        <div className={`section-vcardbody section-page${props.active ? ' section-page-active' : ''}`}>
            ...
            <div className="pageItem">
                <h3 className="itemTitle"><FontAwesomeIcon icon={faPlane} transform={{ rotate: -45 }} />&nbsp; Skygenda - Flight Scheduling Software</h3>
                <h4 className="itemTime">Senior Project<br />2018-2019</h4>
            ...
            <div className="pageItem">
                <h3 className="itemTitle"><FontAwesomeIcon icon={faCompass} />&nbsp; Radio Direction Finding</h3>
                <div className="description">
            ...
            <div className="pageItem">
                <h3 className="itemTitle"><FontAwesomeIcon icon={faTrophy} />&nbsp; WWU ACM Hackathon</h3>
                <h4 className="itemTime">1st Place Wining Team<br />November 2017</h4>
                <div className="description">
            ...
            <div className="pageItem">
                <h3 className="itemTitle"><FontAwesomeIcon icon={faTrophy} />&nbsp; Intel HackOA Hackathon</h3>
                <h4 className="itemTime">1st Place Wining Team<br />October 2017</h4>
                <div className="description">
